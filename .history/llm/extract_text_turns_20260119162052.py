...
num_past_turns = 50
INPUT_FILE = "llm_contrastive/data/lm_test.txt"
BC_FILE = f"llm_contrastive/data/past_turns_test_context_bc/test_set_bc_{num_past_turns}.txt"
CTX_FILE = f"llm_contrastive/data/past_turns_test_context_bc/test_set_context_{num_past_turns}.txt"
